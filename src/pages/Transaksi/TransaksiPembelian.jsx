      ...
      cell: (info) => {
        ...
        return (
          <div className='px-2 py-1 bg-blue-500 rounded-lg font-primary text-white'>
            <Link to={`/invoice/barang/view/${href}`}>View</Link>
          </div>
        );
      },
                ...
                <div className='flex flex-col'>
                  ...
                  <div className='grid grid-cols-2'>
                    <div className='flex flex-col'>
                      ...
                      {/* Kontak */}
                      <div className='flex flex-col'>
                        <label className='my-2'>Nama Customer</label>
                        <input
                          className='bg-gray-100 px-4 py-2 rounded-md border border-gray-400 shadow w-64'
                          type='text'
                          value={searchValue}
                    ...
                    {/* Rincian Barang */}
                    <div className='bg-gray-100 rounded-md p-4 border border-gray-400 shadow-lg h-max'>
                      <div className='flex flex-col'>
